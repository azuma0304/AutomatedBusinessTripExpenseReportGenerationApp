...
import { DepartureDateSchema } from '../../../schemas/user-schema'
...
const DepartureDateInput: React.FC<DepartureDateInputProps> = ({
    value = '',
    onChange,
    error
}) => {
    ...
    const validateField = (inputValue: string) => {
        try {
            DepartureDateSchema.parse(inputValue);
            setValidationError('');
            return true;
        } catch (error: any) {
    ...
    return (
        <>
            <Card containerStyle={{
                ...
                <Card.Title h4 style={{ fontWeight: 'bold' }}>出発日を選択してください</Card.Title>
                    ...
                    >
                        <View style={{ flex: 1, backgroundColor: 'rgba(0,0,0,0.5)', justifyContent: 'center', alignItems: 'center' }}>
                            <Card containerStyle={{ width: '90%', borderRadius: 15, maxHeight: '80%' }}>
                                <Card.Title h4>出発日を選択</Card.Title>
